...
var schemaQueries = []string{
	...
	`ALTER TABLE user_preferences ADD COLUMN IF NOT EXISTS experiences JSONB DEFAULT '[]'::jsonb;`,
	`ALTER TABLE user_preferences ADD COLUMN IF NOT EXISTS projects JSONB DEFAULT '[]'::jsonb;`,
	`ALTER TABLE user_preferences ADD COLUMN IF NOT EXISTS education JSONB DEFAULT '[]'::jsonb;`,
	`ALTER TABLE user_preferences ADD COLUMN IF NOT EXISTS skills JSONB DEFAULT '[]'::jsonb;`,
	`ALTER TABLE user_preferences ADD COLUMN IF NOT EXISTS achievements JSONB DEFAULT '[]'::jsonb;`,
	`ALTER TABLE user_preferences ADD COLUMN IF NOT EXISTS certifications JSONB DEFAULT '[]'::jsonb;`,
